...
if ( ! apply_filters( 'awb_dashboard_menu_cpt', true, $post_type ) || ! apply_filters( 'live_editor_cpt', true, $post_type ) || ( $is_global && ! apply_filters( 'awb_global_elements_access', true ) ) ) {
